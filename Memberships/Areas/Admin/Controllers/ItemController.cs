...
namespace Memberships.Areas.Admin.Controllers
{
    ...
    public class ItemController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Title,Description,Url,ImageUrl,Html,ItemTypeId,PartId,SectionId,WaitDays,IsFree")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Title,Description,Url,ImageUrl,Html,ItemTypeId,PartId,SectionId,WaitDays,IsFree")] Item item)
        {
            if (ModelState.IsValid)
            {
